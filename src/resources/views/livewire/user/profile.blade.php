            ...
            <div>
                ...
                <div class="space-y-4">
                    @forelse($user->joinedCircles as $circle)
                        <a href="{{ route('circles.show', $circle) }}" class="flex items-center space-x-4 p-4 hover:bg-white rounded-2xl border border-transparent hover:border-slate-100 transition-all group">
                            ...
                            <div class="min-w-0 flex-grow">
                                <h4 class="font-bold text-slate-900 truncate group-hover:text-blue-600 transition-colors">{{ $circle->name }}</h4>
                                <span class="text-[10px] font-black uppercase tracking-widest text-slate-400">{{ $circle->type }}</span>
                            </div>
                        </a>
                    @empty
