<div class="max-w-4xl mx-auto py-12 px-4">
    <div class="bg-white/40 backdrop-blur-xl border border-white/40 rounded-[3rem] p-8 md:p-16 shadow-2xl shadow-blue-500/5">
        <div class="mb-12">
            <h1 class="text-4xl font-black text-slate-900 mb-2">Publish New Proof</h1>
            <p class="text-slate-500 font-medium">Document your work, skills, and achievements to build your trust score.</p>
        </div>
